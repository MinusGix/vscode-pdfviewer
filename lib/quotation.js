// Apply if I find that they are needed.
...
//         try {
//             // Try to create URL - if it fails, it's relative
//             new URL(input);
//         } catch {
//             // Resolve relative URL against page base
//             input = new URL(input, window.pageBaseUrl).toString();
//         }
//     }
...
//         } catch {
//             // Resolve relative URL against page base
//             const resolvedUrl = new URL(url, window.pageBaseUrl).toString();
//             return originalOpen.call(xhr, method, resolvedUrl, ...args);
//         }
//     };
